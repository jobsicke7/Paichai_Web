...
// Subject options for grade 2 and 3
...
// Check if user with same school info exists
export async function checkDuplicateStudent(grade: number, className: number, studentNumber: number) {
